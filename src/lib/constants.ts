...
const leadership: Leadership[] = [
  ...
  {
    name: "EHIRIM CHIGAZU GAZY",
    title: "Onitsha Center Manager",
    image: "/images/leadership/onitsha.jpeg",
    bio: "Ehirim Chigazu Gazy is an accomplished IT Business Manager at the Onitsha Center, with over seven years of dedicated experience in technology education. His expertise spans the design and implementation of impactful learning programs, fostering technical proficiency, and driving innovation in IT training. Ehirim combines his passion for technology with a keen business acumen to ensure the smooth operation of the center. He is adept at aligning educational initiatives with organizational goals, managing resources efficiently, and building strong partnerships that enhance the center's offerings. Ehirim’s commitment to empowering learners with cutting-edge skills has made him a trusted figure in tech education.",
  },
  {
  ...
  {
    name: "Amarachi Blessing Ogbonna",
    title: "Umuahia Center Manager",
    pos: "object-center",
    image: "/images/leadership/umuahia.jpeg",
    bio: "Amarachi Blessing Ogbonna is an accomplished Center Manager at the Umuahia branch, with a strong background in tech education training and business development in IT. With more than six years of expertise in computer networking, ethical hacking, and CompTIA certifications, she has established herself as a versatile leader in the technology sector. In her role, Amarachi combines her technical expertise with a passion for education to design and deliver impactful training programs. Her in-depth knowledge of ethical hacking and network security ensures that trainees are equipped with cutting-edge skills to thrive in the rapidly evolving IT landscape. Additionally, her proficiency in CompTIA certifications adds value to learners and organizations alike, enhancing their technical capabilities and career prospects. Amarachi’s leadership at the Umuahia center is defined by her strategic vision, commitment to excellence, and drive to foster innovation. Her ability to balance technical acumen with business development skills has been instrumental in the center’s growth and success.",
  },
  {
    name: "Annabel Nneka Edovia",
    title: "Kubwa Center Manager",
    image: "/images/leadership/kubwa.jpg",
    bio: "Annabel is a dedicated Center Manager at the Kubwa branch in Abuja, bringing a wealth of experience in tech education training and business development in the field of Information Technology. With over six years of professional expertise at Aptech Computer Education, Annabel has honed her skills in delivering world-class IT training programs and fostering growth in the educational sector. Her proficiency lies in designing innovative learning solutions, managing IT training projects, and mentoring individuals to achieve their professional goals. Annabel’s extensive knowledge of Aptech methodologies and certifications enables her to create impactful programs that meet global industry standards, equipping learners with skills that align with the demands of the digital economy. Annabel’s leadership at the Kubwa center is driven by her commitment to excellence, her focus on empowering learners, and her strategic approach to business development. Her dedication to advancing IT education has positioned the center as a hub for innovation and skill-building in the Abuja region.",
  },
];
