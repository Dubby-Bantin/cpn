        ...
        <div>
          <div className="flex flex-col gap-4 mb-14">
            ...
            <div className='flex items-center gap-1'>
              ...
              <p className="text-gray-500">725 5th Ave, New York, NY 10022, USA</p>
            </div>
          </div>
          <div className="flex flex-col gap-4 mb-14">
          ...
          <div className="flex flex-col gap-4 mb-14">
            ...
            <div className='flex items-center gap-1'>
              ...
              <p className="text-gray-500">info@decovista.com</p>
            </div>
          </div>
          <div className="flex flex-col gap-4 mb-14">
        ...
        <div>
          ...
          <form>
            <div className="flex flex-col gap-2 mb-8">
              ...
              <input type="text" className="h-[50px] bg-transparent border border-gray-400 outline-none text-[18px] px-5" />
            </div>
            <div className="flex flex-col gap-2 mb-8">
              <label htmlFor="email">Your Email</label>
              <input type="email" className="h-[50px] bg-transparent border border-gray-400 outline-none text-[18px] px-5" />
            </div>
            <div className="flex flex-col gap-2 mb-8">
            ...
            <button className="h-[50px] bg-transparent border border-black outline-none text-[18px] w-full px-5 cursor-pointer">Submit</button>
          </form>
        </div>
      </div>
    </div>
