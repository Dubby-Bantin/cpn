          ...
          <div className="flex sm:flex-row flex-col justify-center items-center">
            <div className="p-5 text-center sm:text-left">
              ...
              <p className="mb-5 text-sm">
                To create the infrastructure that will deliver <br /> content to
                the right place at the right time and budget
              </p>
              <ul className="gap-2 grid mb-10 text-gray-700 text-sm list-disc">
                <li>
                  Systems integrated and security to protect the <br />{" "}
                  integrity and privacy of shared content across network
                </li>
                <li>
                  High-end and mid range enterprise server installation <br />{" "}
                  and configuration
                </li>
              ...
              <div className="flex sm:flex-row flex-col items-center gap-4">
                <div className="flex flex-col items-center w-96 text-center">
                  ...
                  <p className="text-gray-700 text-sm">
                    ...
                    structure of extra components which are not strictly
                    necessary to functions in case of failure in other
                    components.
                  </p>
                </div>
                <div className="flex flex-col items-center w-96 text-center">
            ...
            <div className="flex sm:flex-row flex-col items-center w-[70rem]">
              <div className="relative -top-16">
                ...
                <p className="text-gray-700 text-sm">
                  ...
                  infrastructure used by enterprises to house computer, server
                  and networking systems and other vectors acting in different
                  directions which are together equivalent for company’s
                  information technology (IT) needs, which typically involve
                  storing, processing and serving large amount of
                  mission-critical data to clients in a client/server
                  construction
                </p>
              </div>
              <Image
            ...
            <div className="flex sm:flex-row flex-col justify-center items-start gap-20 w-[70rem]">
              ...
              <div className="relative -top-25">
                ...
                <div className="gap-5 grid text-gray-700 text-sm">
                  <p>
                    The digital network video surveillance system provides a
                    host of benefits and advanced purposes that cannot be
                    provided by an analogue video surveillance system.
                  </p>
                  <p>
          ...
          <div className="flex justify-center items-start gap-40 mb-10 p-5">
            <div className="flex sm:flex-row flex-col items-center w-[70rem]">
              <div className="relative">
                ...
                <div className="border-primary2 mb-2 border w-28"></div>
                <p className="text-gray-700 text-sm">
                  Cloud Computing is a general term for any activity that
                  involves delivering hosted services over the internet. These
                  services are roadly divided into three categories:
                  Infrastructure-as-a-service (IaaS), Platform-as-a-Service
                  (PaaS) and Software-as-a-Service (SaaS).
                </p>
                <p className="text-gray-700 text-sm">
                  Cloud computing enables companies to consume computer
                  resources as a utility just like electricity rather than
                  having to build and maintain computing infrastructures
                  in-house. It provides sufficient cost effective IT resources
                  as cost on demand IT based on the actual usage of the
                  customer.
                </p>
              </div>
              <Image
          ...
          <div className="flex justify-center gap-40 mb-10 py-20 p-5">
            <div className="flex sm:flex-row flex-col justify-center sm:items-start gap-20 w-[70rem]">
              <div className="relative -top-25">
                ...
                <div className="gap-5 grid text-gray-700 text-sm">
                  <p>
                    A reliable uninterrupted power supply is non-negotiable for
                    IT infrastructure. We understand that time is paramount,
                    especially when it comes to eliminating downtime and
                    maximizing the life of your backup power solution.
                  </p>
                  <p>
                    Our IT power solution shall be tailored to fit your
                    company’s unique requirements and infrastructure. We take
                    proactive approach from selection and implementation to
              ...
              <div className="relative -top-25">
                ...
                <div className="text-gray-700 text-sm">
                  <p>
                    ...
                    your primary objective – YOUR BUSINESS OUTCOMES. To mention
                    a few, whether it’s maximizing the productivity of your
                    employees or improving the quality and capabilities of
                    company personnel, all our interventions have one common DNA
                    i.e. impacting business outcome. Over the years, Center
                    Point Network has championed the art of impacting business
